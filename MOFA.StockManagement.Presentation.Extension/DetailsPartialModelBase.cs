...
{
    public class DetailsPartialModelBase<TIAppService, TViewModel, TKey> : PagePartialModelBase<TIAppService, TViewModel, TKey>
        ...
        where TViewModel : ViewModelBase<TKey>
    {
        ...
        public DetailsPartialModelBase(TIAppService appService) : base(appService)
        {
        }
