...
{
    public class CreateModelBase<TIAppService, TViewModel, TKey> : PageModelBase<TIAppService, TViewModel, TKey>
        ...
        where TViewModel : ViewModelBase<TKey>
    {
        ...
        public CreateModelBase(TIAppService appService, string returnUrl, string area, string? srcvalue = null, string? dstvalue = null) : base(appService)
        {
            _area = area;
