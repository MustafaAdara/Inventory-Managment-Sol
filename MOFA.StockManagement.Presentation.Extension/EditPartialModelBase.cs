...
{
    public class EditPartialModelBase<TIAppService, TViewModel, TKey> : PagePartialModelBase<TIAppService, TViewModel, TKey>
        ...
        where TViewModel : ViewModelBase<TKey>
    {
        ...
        public EditPartialModelBase(TIAppService appService, string? returnUrl = null, string? area = null, string? srcvalue = null, string? dstvalue = null, string? listId = null) : base(appService)
        {
            _area = area;
