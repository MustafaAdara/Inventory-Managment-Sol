...
{
    public class _DetailsModel : DetailsPartialModelBase<IItemTypeAppService, ItemTypeViewModel, Guid>
    {
        public _DetailsModel(IItemTypeAppService appService) :base(appService)
        {
